...
//	mt_set_gpio_mode(199|0X80000000,GPIO_MODE_00);
//	mt_set_gpio_dir(199|0x80000000,GPIO_DIR_OUT);
//	mt_set_gpio_out(199|0x80000000,GPIO_OUT_ZERO);
//	MDELAY(1);
	
//	mt_set_gpio_mode(60  |0x80000000, GPIO_MODE_00);	//data sheet 136 page ,the first AVDD power on
//	mt_set_gpio_dir(60  |0x80000000, GPIO_DIR_OUT);
//	mt_set_gpio_out(60  |0x80000000, GPIO_OUT_ONE);
	
	gpio_set_value(60, 1);

	MDELAY(1);

//	mt_set_gpio_mode(59|0x80000000, GPIO_MODE_00);
//	mt_set_gpio_dir(59|0x80000000, GPIO_DIR_OUT);
//	mt_set_gpio_out(59|0x80000000, GPIO_OUT_ONE);
...
//	mt_set_gpio_mode(57  |0x80000000,GPIO_MODE_00);
//	mt_set_gpio_dir(57  |0x80000000,GPIO_DIR_OUT);
//	mt_set_gpio_out(57  |0x80000000,GPIO_OUT_ONE);
//#endif
//	MDELAY(200);
//	gpio_set_value(57, 0);
//	MDELAY(20);
...
static void lcm_off(void)
{
	SET_RESET_PIN(0);
	MDELAY(7);
//	mt_set_gpio_mode(59|0x80000000, GPIO_MODE_00);	//data sheet 136 page, the first AVDD Power off
//	mt_set_gpio_dir(59|0x80000000, GPIO_DIR_OUT);
//	mt_set_gpio_out(59|0x80000000, GPIO_OUT_ZERO);
	gpio_set_value(59, 0);
	MDELAY(10);	

//	mt_set_gpio_mode(60  |0x80000000, GPIO_MODE_00);
//	mt_set_gpio_dir(60  |0x80000000, GPIO_DIR_OUT);
//	mt_set_gpio_out(60  |0x80000000, GPIO_OUT_ZERO);
	gpio_set_value(60, 0);
	MDELAY(10); 
...
//	mt_set_gpio_mode(199|0x80000000, GPIO_MODE_00);
//	mt_set_gpio_dir(199|0x80000000, GPIO_DIR_OUT);
//	mt_set_gpio_out(199|0x80000000, GPIO_OUT_ONE);
//	MDELAY(5); 
#endif
