...
static unsigned char config_info[SIZE_BATINFO] = {
    ...
    #endif
#if 0
	0x15,0x7F,0x3A,0x79,0x61,0x48,0x44,0x59,
	0x5B,0x4F,0x4D,0x53,0x5E,0x6E,0x65,0x57,
	0x4A,0x41,0x36,0x32,0x38,0x45,0x4B,0x54,
	0x5E,0x50,0x0B,0x85,0x19,0x32,0x6D,0x83,
	0x8B,0x8D,0x8F,0x8D,0x3B,0x17,0x78,0x16,
	0x00,0x22,0x52,0x87,0x8F,0x91,0x94,0x52,
	0x82,0x8C,0x92,0x96,0x8D,0x5B,0x5E,0xCB,
	0x2F,0x7D,0x72,0xA5,0xB5,0xC1,0xA1,0x89,
	#endif
};
...
int get_cw2015_capacity(void)
{
    printk(KERN_ERR "[CW2015] get_cw2015_capacity: %d\n", g_cw2015_capacity);
    return g_cw2015_capacity;
}
EXPORT_SYMBOL(get_cw2015_capacity);

int get_cw2015_voltage(void)
{
    printk(KERN_ERR "[CW2015] get_cw2015_voltage: %d\n", g_cw2015_vol);
    return g_cw2015_vol;
}
EXPORT_SYMBOL(get_cw2015_voltage);
EXPORT_SYMBOL(get_cw2015_voltage);
